...
#Date: 03012020
#Usage: perl cal_distshift_allpairstesting_rmBoth0_multithreads.pl [#threads] [table]
#Examp: perl cal_distshift_allpairstesting_rmBoth0_multithreads.pl 16 normcnt_deseq2
#Description: Perform Wilcoxon rank sum test and print out p-value (i.e., distribution shift) between each Y vs each O.
...
foreach my $sIn (@aFile) {
	...
	open h_outWCX, ">distshift_allpairstesting_rmBoth0_".$sName.".txt";
