...
#Date: 03162020
#Usage: perl cal_dAUC_rmBoth0_nbyn.pl [0 or 1] [table]
#Examp: perl cal_dAUC_rmBoth0_nbyn.pl 0 normcnt_deseq2_GSE101521.1_human_M.txt
#Description: Calculate AUC of each Y vs each O.
...
foreach my $sIn (@aFile) {
	...
	open h_out, ">nbynCD_dAUC_rmBoth0_".$sName.".txt";
